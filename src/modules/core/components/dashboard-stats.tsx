...
const accentStyles: Record<DashboardStat["accent"], { iconBg: string; iconColor: string; glow: string; ring: string }> = {
            ...
            >
              ...
              <div className="relative flex items-start justify-between mb-5">
                <div className={`flex size-11 items-center justify-center rounded-lg bg-gradient-to-br ${style.iconBg} ring-1 ring-inset ring-border/60`}>
                  <s.icon className={`h-5 w-5 ${style.iconColor}`} strokeWidth={2} />
                </div>
